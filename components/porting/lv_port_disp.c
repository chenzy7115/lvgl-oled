...
// static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p);//已经有系统预定义的刷新程序disp_driver_flush（）替换
...
{
    /*You code here*/
    lvgl_driver_init();//这个函数会初始化显示器和显示器触屏，在其他地方如果初始化触屏是需要注意
}
...
//被系统预定义刷新程序disp_driver_flush（）替换
